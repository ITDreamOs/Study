...
namespace lvwei8.Service.Base
{
    ...
    {
        //public static ExceptionResponseViewModel CreateExceptionResponse()
        //{
    ...
    public class BasePageableWebApiResponse<TListType> : BaseListWebApiResponse<TListType>
    {
        /// <summary>
        /// 分页信息
        /// </summary>
    ...
    public class BasePageableClsWebApiResponse<TResult> : BaseWebApiResponse<TResult>
    { /// <summary>
        /// 分页信息
        /// </summary>
        public PageModel Page { get; set; }
